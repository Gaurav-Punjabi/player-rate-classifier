...
public class NaiveBayesDemo implements ClassifierConstants{
    ...
    public String modalSummary(Instances testData) throws Exception{
        evaluation.evaluateModel(naiveBayesUpdateable,testData);
        return evaluation.toSummaryString();
    }

    public double[] evaluateModel(Instances testData) throws Exception{
        return evaluation.evaluateModel(naiveBayesUpdateable,testData);
    }
    ...
    public double predictWorkRate(double pace,double shot, double dribble, double acceleration, double sprint) throws Exception{
        ...
        return naiveBayesUpdateable.classifyInstance(dataset.instance(0));
    }
    ...
    public static void main(String args[]) throws Exception{
        ...
        NaiveBayesDemo demo = new NaiveBayesDemo();
        ...
        /*String  weight = demo.predictWorkRate(instances,scanner.nextDouble(),scanner.nextDouble(),scanner.nextDouble(),
